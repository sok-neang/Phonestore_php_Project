...
<head>
    ...
    <title>Category wise Shop </title>
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        <img class="card-img-top"
                            src="admin/productimages/<?php echo htmlentities($row['productImage1']);?>" width="350"
                            height="300" alt="<?php echo htmlentities($row['productName']);?>" />
                        <div class="card-body p-4">
                            <div class="text-center">
                                <h5 class="fw-bolder"><?php echo htmlentities($row['productName']);?></h5>
                                <span
                                    class="text-decoration-line-through">$<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
