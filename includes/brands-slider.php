<div id="brands-carousel" class="logo-slider wow fadeInUp">
    ...
    <div class="logo-slider-inner">
        <div id="brand-slider" class="owl-carousel brand-slider custom-carousel owl-theme">
            ...
            <div class="item">
                <a href="#" class="image">
                    <img data-echo="brandsimage/nothing-logo.jpg" src="assets/images/blank.gif" alt="">
                </a>
            </div>

            <div class="item">
                <a href="#" class="image">
                    <img data-echo="brandsimage/oppo-logo.jpg" src="assets/images/blank.gif" alt="">
                </a>
            </div>

            <div class="item">
                <a href="#" class="image">
                    <img data-echo="brandsimage/Realme-Logo.png" src="assets/images/blank.gif" alt="">
                </a>
            </div>

            <div class="item">
                <a href="#" class="image">
                    <img data-echo="brandsimage/samsung-logo.jpg" src="assets/images/blank.gif" alt="">
                </a>
            </div>
            <div class="item">
                <a href="#" class="image">
                    <img data-echo="brandsimage/vivo-logo.jpg" src="assets/images/blank.gif" alt="">
                </a>
            </div>
            <div class="item">
                <a href="#" class="image">
