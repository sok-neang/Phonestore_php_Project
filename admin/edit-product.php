...
{?>
                                ...
                                <div class="row" style="margin-top:1%;">
                                    ...
                                    <div class="col-6"><select name="subcategory" id="subcategory" class="form-control"
                                            required>
                                ...
                                <div class="row" style="margin-top:1%;">
                                    ...
                                    <div class="col-6"><input type="text" name="productName"
                                            value="<?php echo htmlentities($row['productName']);?>" class="form-control"
                                            required>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row" style="margin-top:1%;">
                                    ...
                                    <div class="col-6"><input type="text" name="productCompany"
                                ...
                                <div class="row" style="margin-top:1%;">
                                    ...
                                    <div class="col-6"><input type="text" name="productpricebd"
                                ...
                                <div class="row" style="margin-top:1%;">
                                    ...
                                    <div class="col-6"><input type="text" name="productprice"
                                ...
                                <div class="row" style="margin-top:1%;">
                                    ...
                                    <div class="col-6"><textarea name="productDescription"
                                            placeholder="Enter Product Description" rows="6"
                                            class="form-control"><?php echo $row['productDescription'];?></textarea>
                                    </div>
                                </div>

                                <div class="row" style="margin-top:1%;">
                                    <div class="col-2">Product Shipping Charge</div>
                                    <div class="col-6"><input type="text" name="productShippingcharge"
                                ...
                                <div class="row" style="margin-top:1%;">
                                    ...
                                    <div class="col-6"><select name="productAvailability" id="productAvailability"
                                            class="form-control" required>
...
?>
                                ...
                                <div class="row" style="margin-top:1%;">
                                    ...
                                    <div class="col-6"><img
                                            src="productimages/<?php echo htmlentities($row['productImage1']);?>"
                                            width="250"><br />
                                ...
                                <div class="row" style="margin-top:1%;">
                                    ...
                                    <div class="col-6"><img
                                            src="productimages/<?php echo htmlentities($row['productImage2']);?>"
                                            width="250"><br />
                                ...
                                <div class="row" style="margin-top:1%;">
                                    ...
                                    <div class="col-6"><img
                                            src="productimages/<?php echo htmlentities($row['productImage3']);?>"
                                            width="250"><br />
