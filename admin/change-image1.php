                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <?php
                            $pid = intval($_GET['id']);
                            $query = mysqli_query($con, "SELECT productImage1, productName FROM products WHERE id='$pid'");
                            while ($row = mysqli_fetch_array($query)) {
                            ?>
                            <form method="post" enctype="multipart/form-data">
                                <input type="hidden" name="currentimage"
                                    value="<?php echo htmlentities($row['productImage1']); ?>">
                                ...
                                <div class="row" style="margin-top:1%;">
                                    ...
                                    <div class="col-4">
                                        <img src="productimages/<?php echo htmlentities($row['productImage1']); ?>"
                                            width="250"><br />
                                    </div>
                                </div>

                                <div class="row" style="margin-top:1%;">
                                    <div class="col-2">New Product Image</div>
                                    <div class="col-4">
