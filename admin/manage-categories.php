...
<head>
    ...
    <title>Shopping Portal | Manage Categories</title>
...
?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit-category.php?id=<?php echo $row['catid']?>"><i
                                                    class="fas fa-edit"></i></a> |
                                            <a href="manage-categories.php?id=<?php echo $row['catid']?>&del=delete"
