        ...
        <div class="container px-4  mt-5">
            ...
            <form method="post" name="signup">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-6"><input type="text" name="contactnumber" pattern="[0-9]{10}"
                ...
                <div class="row mt-3">
                    <div class="col-4">&nbsp;</div>
                    <div class="col-6"><input type="submit" name="submit" id="submit" class="btn btn-primary" required>
                    </div>
                </div>
            </form>
